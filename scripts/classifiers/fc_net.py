...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for ii in range(1, self.num_layers + 1):
            ...
            cache_name = "cache" + _layer_str_name
        ...
        for i in range(self.num_layers, 0, -1):
            ...
            if self.num_layers == i:
                dx, grads[_W_str_name], grads[_b_str_name] = affine_backward(dx, caches[cache_name])
                
            else:
                (_, grads[_W_str_name], grads[_b_str_name]) = affine_relu_backward(dx, caches[cache_name])
